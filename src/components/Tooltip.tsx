    ...
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Positioner sideOffset={10}>
        <TooltipPrimitive.Popup
          className={cn(
            "flex flex-col px-2 py-1 rounded-md bg-sky-900/50 text-sm origin-(--transform-origin) shadow-lg shadow-gray-200 outline-1 outline-sky-900/50 transition-[transform,scale,opacity] data-ending-style:opacity-0 data-ending-style:scale-90 data-instant:transition-none data-starting-style:opacity-0 data-starting-style:scale-90 dark:shadow-none dark:outline-sky-900/10 dark:-outline-offset-1",
            className,
          )}
          {...props}
        >
